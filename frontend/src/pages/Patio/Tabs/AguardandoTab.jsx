...
const AguardandoTab = ({ cargas, onClickCarga }) => {

  if (cargas.length === 0) {
    return <div className="p-4 text-center text-muted">Nenhuma carga aguardando veículo.</div>;
  }
  ...
  return (
    <div className="list-group list-group-flush w-100">
      {cargas.map(carga => (
        <div 
          key={carga.ID_Carga} 
          className="list-group-item border-0 border-bottom border-start border-4 border-warning d-flex justify-content-between align-items-center bg-white rounded-0"
